...
func (m *CraftingModel) recordInputHistory(value string) {
	if m == nil {
		return
	}
...
func (m *CraftingModel) resetInputHistoryNavigation() {
	if m == nil {
		return
	}
...
func (m *CraftingModel) canNavigateInputHistory() bool {
...
func (m *CraftingModel) navigateInputHistory(delta int) bool {
