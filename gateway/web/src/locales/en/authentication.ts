export const authentication = {
  ...
  recoveryTitle: "Where do I find this token?",
  recoveryDocker: "For Docker, run this command from the OneDay directory:",
  recoveryOther: "For another installation, retrieve ONEDAY_GATEWAY_BOOTSTRAP_TOKEN from the secret environment used to start the gateway.",
