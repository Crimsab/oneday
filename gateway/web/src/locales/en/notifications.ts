export const notifications = {
  ...
  branch: { active: "Active branch: {{name}}.", updated: "updated", previousDecision: "Back at the previous decision on {{name}}.", navigatorOpened: "Story branch navigator opened in the sidebar.", forkUsage: "Usage: /fork <branch name>", renameUsage: "Usage: /branch-rename <name>", notFound: "Branch not found: {{name}}", missingName: "(missing name)", noDecision: "There is no completed decision to retry yet." },
