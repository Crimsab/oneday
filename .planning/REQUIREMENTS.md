...
- [x] **MINI-06**: Story packs can define stats, difficulty profiles, challenge pools, and outcome policies without hardcoding a genre into the engine.
- [x] **MINI-07**: Golden/playtest evals cover generosity bias, anti-loop progression, false identity, metamorphosis, zero-combat, social comedy, deterministic replay, and cross-surface parity.
