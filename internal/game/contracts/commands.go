...
func CommandDescriptors(localizers ...appi18n.Localizer) []CommandDescriptor {
	descriptors := []CommandDescriptor{
		...
		{ID: "retry", Canonical: "retry", Aliases: []string{"try-again"}, Title: "Try another choice", Description: "Restore the latest decision on a new branch and keep the current path.", Group: CommandGroupState, Parity: CommandParityShared, Behavior: CommandBehaviorTimeline, Examples: []string{"/retry"}},
		{
			ID:                 "talk",
			Canonical:          "talk",
			Title:              "Talk",
