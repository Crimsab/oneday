  ...
  return {
    probes: [
      ...
      },
      {
        ...
        status: "skipped",
        required: false,
        summary: "RAG embeddings are disabled",
        action: "",
      },
      {
        name: "image",
        ...
        status: "skipped",
        required: false,
        summary: "image generation is disabled",
        action: "",
      },
      {
        name: "tts",
        ...
        status: "skipped",
        required: false,
        summary: "text-to-speech is disabled",
        action: "",
      },
      {
        name: "gateway",
        ...
        status: "skipped",
        required: false,
        summary: "gateway readiness is disabled",
        action: "configure",
      },
      {
        name: "storage",
      ...
      {
        name: "backup",
        code: "BACKUP_NO_DATABASE",
        status: "skipped",
        required: false,
        summary: "no database exists yet to back up",
        action: "",
      },
    ],
    ...overrides,
...
describe("InstallationOnboarding", () => {
  ...
  it("preserves an existing configuration and keeps story onboarding separate", () => {
    ...
    expect(html).toContain(
      "Story setup begins only after this installation is ready",
    );
          ...
          probes: [
            {
              ...
              status: "failed",
              required: true,
              summary: "no narrative provider is enabled",
              action: "configure",
            },
            {
              name: "image",
