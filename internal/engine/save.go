...
func insertWorldStateRow(tx *sql.Tx, world *storage.WorldState) error {
	_, err := tx.Exec(
		...
		world.WorldReactionsJSON, world.InvestigationBoardJSON, world.PlayerGuidanceJSON, world.FrontsJSON, world.CurrentChapter, world.CurrentTurn, world.UpdatedAt,
	)
	return err
}
