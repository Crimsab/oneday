export const library = {
  ...
  importStory: "Importa", exportStory: "Esporta", importFile: "ZIP OneDay o template del mondo", chooseFile: "Scegli file", orShareCode: "oppure incolla un codice", importCode: "Importa codice",
