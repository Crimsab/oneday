...
export function MessageLanguageControl({ storyId, text, storyLanguage, isUser, onTranslationChange }: {
  ...
  return (
    <div className="message-language-control">
      <button type="button" className="message-language-trigger" onClick={() => setOpen((value) => !value)} aria-expanded={open} aria-haspopup="dialog" disabled={busy}>
      ...
      {open && (
        <div className="language-picker" role="dialog" aria-label={t("transcript.translation.choose")}>
