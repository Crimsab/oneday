  ...
  await page.addInitScript(({ updateAvailable }) => {
    ...
    const values: Record<string, unknown> = {
      ...
      check_update: updateAvailable
        ? { available: true, version: "1.18.0", notes: "Simpler setup, provider parity, and safer updates.", publishedAt: "2026-08-01T00:00:00Z", message: "OneDay 1.18.0 is available. Review it before installing." }
